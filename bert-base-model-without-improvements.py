...
print('Length of the train contexts -----> {}'.format(len(train_contexts)))
print('Length of the train questions --> {}'.format(len(train_questions)))
print('Length of  the train answers -> {}'.format(len(train_answers)))


num_q, num_pos, num_imp, valid_contexts, valid_questions, valid_answers = get_data(test_data_path)


print('Length of val_contexts --> {}'.format(len(valid_contexts)))
print('Length of val_questions --> {}'.format(len(valid_questions)))
print('Length of val_answers ----> {}'.format(len(valid_answers)))
...
for epoch in range(EPOCHS):
    ...
    print(f"Training  Accuracy =====> {train_acc}      Train Loss =====> {train_loss}")
...
print('  == WORD ERROR RATE  == ',wer_list)